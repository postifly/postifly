...
export default function How({ isKa }: Props) {
  ...
  const steps = isKa
    ? [
        ...
        " დარეგისტრირდით ჩვენს საიტზე www.posstify.ge;",
        ' www.posstify.ge/-ზე ავტორიზაციის გავლის შემდეგ, მისამართების ველში გამოჩნდება თქვენთვის მინიჭებული ყველა ქვეყნის მისამართი, რომლიდანაც "დააკოპირებთ" სასურველ მისამართს და ჩასვამთ ონლაინ მაღაზიის საიტზე შესაბამის ველებში.',
    ...
    : [
        ...
        " After logging in on www.posstify.ge, all country addresses assigned to you will appear in the addresses section; copy the desired address and paste it into the corresponding fields on the online store’s website.",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <section
        id="subscribe"
        className="w-full  pb-16 md:pb-24 px-4"
      >
