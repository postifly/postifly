...
const Services = () => {
    ...
    return (
        <>
            <section className="relative w-full overflow-hidden bg-white pb-0 md:pb-14 flex items-center justify-center">
                <div
                        ...
                        {services.map((service, index) => (
                            ...
                            >
                                ...
                                <div className="flex flex-col items-center px-4 md:px-6 py-6 md:py-8">
                                    ...
                                    <div className="mb-4 md:mb-6 rounded-2xl bg-white p-4 md:p-5 ring-1 ring-gray-200 shadow-[0_8px_32px_rgba(0,0,0,0.08)] backdrop-blur-sm">
                                        <img
                                            src={service.src}
                                            alt={t(service.altKey)}
                                            width={50}
                                            height={50}
                                            className="w-12 h-12 md:w-16 md:h-16 object-contain drop-shadow-[0_2px_8px_rgba(0,0,0,0.08)]"
                                        />
                                    </div>
